...
function playRound(playerSelection, computerSelection) {
    if (playerSelection === computerSelection) {
        console.log(`COMPUTER: ${computerSelection.charAt(0).toUpperCase() + computerSelection.slice(1)} --- Draw!`);
        return 'draw';
    }
...
function game() {
    ...
    console.log('Welcome to the Rock, paper, scissors game. The game is played for 5 rounds. Good luck!');
    ...
    for (let i = 0; i < 5; i++) {
        ...
        console.log(`CURRENT RESULT: [PLAYER:${playerScore} COMPUTER:${computerScore}]`);
    }
    ...
    if (playerScore > computerScore) {
        ...
        console.log(`[PLAYER:${playerScore} COMPUTER:${computerScore}] YOU LOST THE GAME!`)
    }
    else {
        console.log(`[PLAYER:${playerScore} COMPUTER:${computerScore}] IT'S A DRAW!`)
    }   
}
